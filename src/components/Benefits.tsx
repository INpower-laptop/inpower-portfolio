  ...
  return (
    <Container className="flex flex-wrap mb-20 lg:gap-10 lg:flex-nowrap">
      <div className={`flex items-center justify-center w-full lg:w-1/2 ${props.imgPos === "right" ? "lg:order-1" : ""}`}>
        <div className="animate-float">  {/* Apply the animation class here */}
          <Image
            src={data.image}
            width={531}
            height={531}
...
function Benefit(props: any) {
  return (
    <div className="flex items-start mt-8 space-x-3">
      <div className="flex items-center justify-center flex-shrink-0 mt-1 bg-[#20176d] rounded-md w-11 h-11">
        {React.cloneElement(props.icon, {
          className: "w-7 h-7 text-[#05c8fe]",
        })}
      </div>
      <div>
